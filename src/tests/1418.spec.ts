...
test("1418", () => {
    ...
    ).toEqual([["Table", "Beef Burrito", "Ceviche", "Fried Chicken", "Water"], ["3", "0", "2", "1", "0"], ["5", "0", "1", "0", "1"], ["10", "1", "0", "0", "0"]])
    expect(
    ...
    ).toEqual([["Table", "Canadian Waffles", "Fried Chicken"], ["1", "2", "0"], ["12", "0", "3"]])
    expect(
        displayTable([["Laura", "2", "Bean Burrito"], ["Jhon", "2", "Beef Burrito"], ["Melissa", "2", "Soda"]])
    ).toEqual([["Table", "Bean Burrito", "Beef Burrito", "Soda"], ["2", "1", "1", "1"]])
})
